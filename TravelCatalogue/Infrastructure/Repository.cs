...
namespace TravelCatalogue.Infrastructure
{
    public static class Repository
    {
        ...
        static Repository()
        {
            ...
            var Japan = new BoxTips("Japan", "Chicken Tikka Masala", "Women should be ready to cover themselves in certain areas", "Scooters and busses are the most common form of transport");
